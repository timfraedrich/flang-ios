...
struct NotationTests {
    ...
    func testFBNAfterMoves() throws {
        ...
        // Make some moves
        let fromG2 = try #require(BoardPosition(algebraic: "G2"))
        let toH3 = try #require(BoardPosition(algebraic: "H3"))
        try game.perform(.move(from: fromG2, to: toH3))

        let fromB7 = try #require(BoardPosition(algebraic: "B7"))
        let toB6 = try #require(BoardPosition(algebraic: "B6"))
    ...
    func testFMNSimpleMoves() throws {
        ...
        for (from, to) in moves {
            let fromIdx = try #require(BoardPosition(algebraic: from))
            let toIdx = try #require(BoardPosition(algebraic: to))
